...
<html>
    ...
    <body>
        <div class="container">
            ...
            <DIV class="well" style="background-color:  #999;">
                <h2 id="cityhead">Beautiful City</h2>
            </DIV>
    ...
    <tbody>
      <tr>
        <td><?php $str1 = 'DEHRADUN'; $strshuff1 = str_shuffle($str1); echo $strshuff1;?></td>
 ...
 if (!empty($_POST)){
              ...
              $in9 = $_POST["in9"]; 
              $in10 = $_POST["in10"];
              if (strcasecmp("DEHRADUN",$in1) == 0){
                  $score = $score+1;
              }
              if (strcasecmp("PATNA",$in2) == 0) {
                  $score = $score+1;
              }
              if (strcasecmp("BENGALURU",$in3) == 0) {
                  $score = $score+1;
              }
              if (strcasecmp("RAJASTHAN",$in4) == 0) {
                  $score = $score+1;
              }
              if (strcasecmp("KARNATAKA",$in5) == 0) {
                  $score = $score+1;
              }
              if (strcasecmp("KERALA",$in6) == 0) {
                  $score = $score+1;
              }
              if (strcasecmp("MUMBAI",$in7) == 0) {
                  $score = $score+1;
              }
              if (strcasecmp("KANPUR",$in8) == 0) {
                  $score = $score+1;
              }
              if (strcasecmp("KOLKATA",$in9) == 0) {
                  $score = $score+1;
              }
              if (strcasecmp("CHANDIGARH",$in10) == 0) {
                  $score = $score+1;
              }
